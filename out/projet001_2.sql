...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2020 at 10:36 PM
...
(21, 'connecté', '2020-10-29 08:31:02', 2),
(22, 'connecté', '2020-10-29 10:21:03', 2),
(23, 'connecté', '2020-10-29 10:21:05', 2),
(24, 'connecté', '2020-10-29 10:21:20', 2),
(25, 'connecté', '2020-10-29 10:21:17', 2);
...
(4, NULL, '2020-10-29 23:42:47', 4, NULL);
...
(4, '12312412', 'ossama', 'kdfg', 1231353235, '2020-10-12', '&amp;é&amp;é&quot;&amp;é&quot;', '&amp;é&quot;&amp;', 1000, 0);
...
(1, '2020-10-26 04:00:00', NULL, NULL, 0, 6, 1),
(2, '2020-10-26 13:04:21', NULL, NULL, -1, 6, 3),
(3, '2020-10-26 19:21:00', NULL, NULL, -1, 6, 2);
...
(104, 'infraction de zone', '2020-10-29 00:00:00', -15, 5, 1),
(105, 'infraction de zone', '2020-10-29 00:00:00', -15, 5, 2);
...
(1, 'test@gmail.com', 'Super admin', 'azerty', 3),
(12, 'test@gmail.fr', 'admin', 'azerty', 1),
(13, 'test@hotmail.com', 'Sous admin', 'azerty', 3);
...
--
ALTER TABLE `historique`
  MODIFY `idHistorique` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `queueroom`
  MODIFY `idQueueRoom` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `recordpoints`
  MODIFY `idRecordPoints` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
