<?php
    ...
    if($isSuccess){
        ...
        try{
            $db = Database::connect();
            $statement = $db->prepare("Update utilisateur set emailUtilisateur = ?,roleUtilisateur = ?,passUtilisateur = ?,idPersonnel = ? where  idUtilisateur = '3'");
            $id = $_POST["id"];
            $statement->execute([NULL,$email,"2",$pass,"1",$id]); 
            $status = true;
        }catch(Exception $e){
    ...
    <body>
        ...
        <div class="row" style="margin-top:131px;">
            ...
            <div class="form-group" enctype="multipart/form-data">
                <input type="text" name="email"  id="name" placeholder="email"   value="<?php echo $email; ?>">
                <span class="help-inline"  style="color:red"> 
                <?php echo $NomError; ?>
                </span>                
                </div>  
                <div class="form-group" enctype="multipart/form-data">
                <input type="password" name="pass"  id="Prenom" placeholder="password"   value="">
                <span class="help-inline"  style="color:red"> 
                <?php echo $PrenomError; ?>
                </span>                
                </div> 
                <div class="form-group" enctype="multipart/form-data">
                <input type="password" name="confirmpassword"  id="CIN" placeholder="confirmer le mot de passe"   value="">
                <span class="help-inline"  style="color:red"> 
                <?php echo $CINError; ?>
                </span>                
                </div>   
